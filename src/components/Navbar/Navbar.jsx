      ...
      <div className="navbar-end flex items-center space-x-4">
        <label className="swap swap-rotate">
          <input 
            ...
            className="sr-only"
          />
          <div className="swap-off btn btn-ghost btn-circle">
          ...
          <div className="swap-on btn btn-ghost btn-circle">
            <svg className="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        {user ? (
          <div className="flex items-center gap-3">
            ...
            <span className="text-base-content font-medium hidden sm:block">
              {user.displayName || "User"}
            </span>
            <button 
              onClick={handleSignOut}
              className="btn btn-ghost text-error hover:bg-error/10 transition-colors"
            >
              Logout
            </button>
          </div>
